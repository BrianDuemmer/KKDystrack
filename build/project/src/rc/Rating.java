...
public class Rating 
{
	...
	public Rating(String songID)
	{
		try {
			...
			PreparedStatement ps = DysMain.db.getDb().prepareStatement("SELECT rating_pct, rating_num FROM " +RCTables.playlistTable.getName()+ " WHERE song_id=?;");
			ps.setString(1, songID);
			
			ResultSet rs = DysMain.db.execRaw(ps);
